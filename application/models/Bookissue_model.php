...
class Bookissue_model extends MY_Model {
    ...
    /* Old issue book function. Not used anymore */
    ...
    /* New issue book function */
    public function saveIssueBookList($data) {
        $this->db->insert('book_issues',$data);
        return true;
	}
    ...
    /* Old return book. Not used anymore */
    ...
    /* New return book function */
    public function saveReturnBookList($book_id,$duereturn_date,$member_id,$book_isbn) {
        $where = "member_id='$member_id' and book_isbn='$book_isbn' and is_returned='0'";
        $update_data = array(
            "book_id"     => $book_id,
            "return_date" => $duereturn_date,
            "member_id"   => $member_id,
            "book_isbn"   => $book_isbn,
            "is_returned" => 1
        );
