...
class Member extends Admin_Controller {
    ...
    /* Old unused issuing function before scanning of books was introduced */
    ...
    /* New issuing function */
    public function issueBook() {
        date_default_timezone_set("Africa/Nairobi");
		$data['book_id']        = $this->input->post('book_id');
        $data['duereturn_date'] = $this->input->post('return_date');
        $data['issue_date']     = date('Y-m-d');
		$data['member_id']      = $this->input->post('member_id');
		$data['book_isbn']      = $this->input->post('book_isbn');
		$response=$this->bookissue_model->saveIssueBookList($data);
		if($response == true) {
            echo "success";
		}
		else {
    ...
    /* New book returning function */
    public function returnBook() {
        date_default_timezone_set("Africa/Nairobi");
		$book_id        = $this->input->post('book_id');
        $duereturn_date = $this->input->post('return_date');
		$member_id      = $this->input->post('member_id');
		$book_isbn      = $this->input->post('book_isbn');
		$response       = $this->bookissue_model->saveReturnBookList($book_id,$duereturn_date,$member_id,$book_isbn);
		if($response == true) {
            echo "success";
		}
		else {
    ...
    /* Old book returning function. Not used anymore */
