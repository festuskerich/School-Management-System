...
class Book extends Admin_Controller
{
    ...
    public function getisbn()
    {
    	...
    	foreach($data as $row)
    	{
            ...
            echo "<td>".$row->dat."</td>";
            echo "<td><a href='javascript:void(0);' class='delete_button' data-id='".$row->id."'>Delete</a></td>";
            echo "</tr>";
    	}
	}
    ...
    {
    	$data=$this->book_model->getinventorybarcode();
    	foreach($data as $row)
    	{
            echo "<tr>";
            echo "<td>".$row->barcode."</td>";
