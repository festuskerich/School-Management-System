...
<?php } if ($sch_setting->father_occupation) { ?>
 ...
 <?php } if ($sch_setting->student_email) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('father_email'); ?></label>
...
<?php } if ($sch_setting->father_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputFile"><?php echo $this->lang->line('father'); ?> other email</label>
                                                    <div><input class="form-control" type='text' name='father_pic' id="file" size='20' />
                                                    </div>
...
<?php } if ($sch_setting->mother_phone) { ?>
   ...
   <?php } if ($sch_setting->mother_occupation) { ?>
                          ...
                          <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('mother_email'); ?></label>
...
<?php } if ($sch_setting->mother_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputFile"><?php echo $this->lang->line('mother'); ?> Other Email</label>
                                                    <div><input class="form-control" type='text' name='mother_pic' id="file" size='20' />
                                                    </div>
                                                    <span class="text-danger"><?php echo form_error('file'); ?></span></div>
                                            </div>
<?php } ?>
