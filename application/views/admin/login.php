...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>backend/theme/assets/images/fav.jpg">
    <link rel="stylesheet" href="<?php echo base_url(); ?>backend/theme/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>backend/theme/assets/css/fontawsom-all.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>backend/theme/assets/css/style.css" />
</head>
                    ...
                    <div class="row no-margin w-100 bklmj">
                        <div class="col-lg-6 col-md-6 log-det">
                                                                              <div class="form-bottom">
                                                                                   <img src="<?php echo base_url(); ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo(); ?>" / width="160%" height="40%"> 
...
<script src="<?php echo base_url(); ?>backend/theme/assets/js/jquery-3.2.1.min.js"></script>
<script src="<?php echo base_url(); ?>backend/theme/assets/js/popper.min.js"></script>
<script src="<?php echo base_url(); ?>backend/theme/assets/js/bootstrap.min.js"></script>
<script src="<?php echo base_url(); ?>backend/theme/assets/js/script.js"></script>
