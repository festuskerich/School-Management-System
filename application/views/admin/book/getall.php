                ...
                <div class="box box-primary" id="bklist">
                    <div class="box-header ptbnull">
                        <div class="row">
                            ...
                            <div class="col pull-left" style="margin-left: 80%;">
                                <?php if ($this->rbac->hasPrivilege('books', 'can_add')) { ?>
                                    <a href="<?php echo base_url() ?>admin/isbn">
                                        <button class="btn btn-warning btn-sm" autocomplete="off"><i class="fa fa-print"></i> <?php echo 'Print ISBN'; ?>
                                        </button>
                                    </a>
                                <?php } ?>
                            </div>
                            <div class="col pull-right">
                                <?php if ($this->rbac->hasPrivilege('books', 'can_add')) { ?>
                                    <a href="<?php echo base_url() ?>admin/book">
                                        <button class="btn btn-primary btn-sm" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('book'); ?>
                                        </button>
                                    </a>
                                <?php } ?>
                            </div><!-- /.pull-right -->
