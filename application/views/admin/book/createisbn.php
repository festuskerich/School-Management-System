        ...
        <div class="row">
            <div class="col-md-5">
                <div class="box box-primary" style="padding: 1rem; padding-top: 0 !important;">
                    <h3 class="box-title"><?php echo 'Book ISBN Barcodes'; ?></h3>
            ...
            <div class="col-md-7">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo 'Create & Print Book ISBN'; ?></h3>
                    ...
                    <div class="mt-5" style="background-color: #ffffff;">
                	    <div class="row">
                    		<form method="POST">
                    		    ...
                    		    <div class="col-md-2">
                    		        ...
                    		        <button class="btn btn-primary" name="generate" onclick="saveBookIsbnBarcode()">Generate</button>
                    		    </div>
                    		</form>
                		</div>
                        ...
                        <script>
                            ...
                            function saveBookIsbnBarcode() {
                                var book_isbn = document.getElementById('barcode').value;
                                var isbn_description = document.getElementById('description').value;
                                $.ajax({
                                    type: "POST",
                                    url: base_url + "admin/isbn/saveBookIsbnBarcode",
                                    data: {'book_isbn': book_isbn, 'isbn_description': isbn_description},
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
    		url: "<?php echo base_url().'/admin/book/getisbn';?>",
    		type: "POST",
    		cache: false,
    		success: function(data) {
    		    if(data == null || data == "") {
