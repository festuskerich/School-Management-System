                        ...
                        <div class="box-header with-border">
                            ...
                            <?php if ($this->rbac->hasPrivilege('books', 'can_add')) { ?>
                                <a href="<?php echo base_url() ?>admin/barcode">
                                    <button class="btn btn-warning btn-sm" autocomplete="off"><i class="fa fa-print"></i> <?php echo 'Print Barcode'; ?>
                                    </button>
                                </a>
                            <?php } ?>
                        </div>
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/item"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="code" name="code" placeholder="" type="text" class="form-control" />
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>
                                <div class="form-group">
