                ...
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/sibling_report') ?>" method="post" class="" id="class_search_form"  >
                        <div class="box-body row">
                            ...
                            <div id="class-section" class="col-sm-4 col-md-3">
                                <div class="form-group">
                            ...
                            <div id="section-section" class="col-sm-4 col-md-3">
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                                                    <button style="margin-right: 10px;" name="exportAll" value="" class="btn btn-primary btn-sm checkbox-toggle pull-right"><i class="fas fa-scroll"></i>Export All</button>
