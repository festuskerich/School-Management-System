...
if ($this->config->item('SSLK') == "") {
 ...
 <div class="topaleart">
   ...
   <p style="color:transparent" class="palert"><strong>Alert!</strong> You are using unregistered version of Smart School. Please <a  href="#" class="purchasemodal"></a> to register your purchase code for Smart School.</p>
</div></div>
</div>
                    <?php
}
